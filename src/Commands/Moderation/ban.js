...
module.exports.run = async (bot, msg, args) => {
	...
	if (toBan == msg.member) return msg.channel.send(error("You can't ban yourself, dummy."));
	if (!toBan) return msg.channel.send(usageErr("You didn't specify someone to ban.", "ban"));
